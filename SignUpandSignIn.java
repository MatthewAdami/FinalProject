...
public class SignUpandSignIn extends JFrame {
	...
	private void initialize() {
		...
		passwordFieldSIgnUp.setFont(new Font("Zen Maru Gothic", Font.BOLD, 13));
		...
		emailFieldSignUp.setFont(new Font("Zen Maru Gothic", Font.BOLD, 13));
		...
		footerSignUp.setIcon(new ImageIcon(SignUpandSignIn.class.getResource("/images/dogandcat.png")));
		...
		FooterLogIn.setIcon(new ImageIcon(SignUpandSignIn.class.getResource("/images/pets.png")));
		...
		Logo = new JLabel("");
		Logo.setIcon(
				new ImageIcon(SignUpandSignIn.class.getResource("/images/backgrounds_SIGN IN (1250 × 870px).gif")));
