...
public class AddDataFormImmunization extends JFrame {
	 public static void main(String[] args) {
	        // Create a new table model
	        DefaultTableModel model = new DefaultTableModel();

	        // Create the frame and pass the table model to it
	        AddDataFormImmunization frame = new AddDataFormImmunization(model);
    ...
    public AddDataFormImmunization(DefaultTableModel model) {
        ...
        try {
        	fieldsFont = Font.createFont(Font.TRUETYPE_FONT, new File("C:\\Users\\mateo\\eclipse-workspace\\PROJECT\\src\\Main_Project\\NunitoSans_7pt_Condensed-Medium.ttf"));
        ...
        try {
        	buttonFont = Font.createFont(Font.TRUETYPE_FONT, new File("C:\\Users\\mateo\\eclipse-workspace\\PROJECT\\src\\Main_Project\\NunitoSans_7pt_Condensed-Bold.ttf"));
            GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    weight = Double.parseDouble(weightTextField.getText());
                	 ...
                	 JOptionPane.showMessageDialog(AddDataFormImmunization.this,
        ...
        Logo = new JLabel("");
        Logo.setIcon(new ImageIcon(AddDataFormImmunization.class.getResource("/images/SYSTEMLOGO 1.png")));
        Logo.setBounds(393, 23, 199, 82);
        HeaderPanel.add(Logo);
        
        GroupOfPets = new JLabel("");
        GroupOfPets.setIcon(new ImageIcon(AddDataFormImmunization.class.getResource("/images/GorupofPEts.png")));
        ...
        Font LabelFont = null;
        try {
        	LabelFont = Font.createFont(Font.TRUETYPE_FONT, new File("C:\\Users\\mateo\\eclipse-workspace\\PROJECT\\src\\Main_Project\\NunitoSans_7pt_Condensed-Bold.ttf"));
            GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
        ...
        HeaderLAbelImmunizationandDewormingInput.setIcon(new ImageIcon(AddDataFormImmunization.class.getResource("/images/Group 113.png")));
