	...
	private void initialize() {
		...
		try {
			customFont = Font.createFont(Font.TRUETYPE_FONT, new File(
					"C:\\Users\\mateo\\eclipse-workspace\\PROJECT\\src\\Main_Project\\ZenMaruGothic-Black.ttf"));
		...
		MenuButton.setIcon(new ImageIcon(KnownConditionandAllergies.class.getResource("/images/Signoutmyprofile.png")));
		...
		knownallergies
				.setIcon(new ImageIcon(KnownConditionandAllergies.class.getResource("/images/knownallergies.png")));
		...
		clearButton.setIcon(new ImageIcon(KnownConditionandAllergies.class.getResource("/images/Clearbutton.png")));
		...
		immunizationbttn
				.setIcon(new ImageIcon(KnownConditionandAllergies.class.getResource("/images/RegularDeworming.png")));
		...
		mypetsbttn.setIcon(new ImageIcon(KnownConditionandAllergies.class.getResource("/images/petbutton.png")));
